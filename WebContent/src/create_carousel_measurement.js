function create_carousel_measurement(m,id_carousel) {
	...
	description+='<tr><td>Flow Intensity:</td><td>'+m[i]['Flow Intensity (High/Medium/Low)']+' m</td></tr>'
	description+='<tr><td>Flow Direction:</td><td>'+m[i]['Flow Direction (Degrees)']+' m</td></tr>'
	...
	description+='<tr><td>Photo Distance:</td><td>'+m[i]['Photo Distance (Mt)']+'</td></tr>'
